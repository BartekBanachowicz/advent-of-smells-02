...
public class application {
	...
	/*	
		...
		*/
		...
		System.out.println("����һ�����ݿ�CHI...");
		String[] rowName3=new String[Classes.length] ;//����
		for (int k = 0; k <Classes.length; k++) {
			rowName3[k]="CHI"+Classes[k];
		}
		dbCHI1=d.getData("����CHI", rowName3);
	/*	
		System.out.println("����һ�����ݿ�TFIDF...");
		String[] rowName4=new String[Classes.length] ;//����
		for (int k = 0; k <Classes.length; k++) {
			rowName4[k]="TFIDF"+Classes[k];
		}
		TFIDF=d.getData("����TFIDF", rowName4);
		*/
		...
		for(int i=0;i<Classes.length;i++){
			...
			String[] rowName2=new String[Classes2.length] ;//����
			for (int k = 0; k <Classes2.length; k++) {
				rowName2[k]="����"+Classes2[k];
			}
			db2[i]=d.getData(tableName, rowName2);
			
		}
		
		System.out.println("����������ݿ�CHI...");
	...
	/*	
		System.out.println("����������ݿ�TFIDF...");

		for(int i=0;i<Classes.length;i++){
			String[] Classes2 = tdm.get2ClassificationsName(Classes[i]);
			String tableName="��TFIDF"+Classes[i];
			String[] rowName2=new String[Classes2.length] ;//����
			for (int k = 0; k <Classes2.length; k++) {
...
/*		
	...
	//			float probility=(float) Math.log(PriorProbability.calculatePc(Classes[j]));
			...
			log("һ����ȷ��"+n1+"/"+(i+1));
			this.Result+="�������ڣ�"+crs.get(0).classification+"\n\n";
			...
			List<ClassifyResult> crs2 = new ArrayList<ClassifyResult>();//������
